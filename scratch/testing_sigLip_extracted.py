...
gt_masks, pred_masks_syn = get_segmentation_masks(image, annotations, syn_cats, coco, model, processor)
...
gt_masks, pred_masks_hyper = get_segmentation_masks(image, annotations, hyper_cats, coco, model, processor)
...
gt_masks, pred_masks_hypo = get_segmentation_masks(image, annotations, hypo_cats, coco, model, processor)
